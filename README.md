...
The 12 PNG files for the chess piece icons must be present in /assets/images.
'MainGame.py', 'ClientGame.py', 'GameEngine.py' and 'Network.py' must be present in /src/.
